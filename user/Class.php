							...
							<div class="row "><div class="col-sm-6 col-md-3">						
								...
								<div class="col-sm-6 col-md-3">
									<form action="newatt.php" method="post">
										...
										</form></div><div class="col-sm-6 col-md-3">
											<button onclick="exportToExcel('basic-datatables','<?php echo $col;?>');" class="btn btn-success btn-round"><i class="fas fa-download"></i> Download Attendance</button></div></div>
										</h4>
									</div>
									<div class="card-body">
